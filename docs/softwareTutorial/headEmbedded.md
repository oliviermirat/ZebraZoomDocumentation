...
# Head-embedded fish tail tracking
...
Then answer all the questions asked. Make sure to choose "Tail tracking of head-embedded fish".
...
![alt text](./static/img/chooseTestBeginningHeadEmbedded.png)
...
Once all the manual selection of center of the head and tail tip coordinates is done, you can click on "Run ZebraZoom on an entire folder" in order to run the actual tracking on all videos.

![alt text](./static/img/runtrackingPageHeadEmbedded.png)




Here is below a tutorial video of how to launch the tracking on several videos, first by selecting the base of the tail and tail tip coordinates, then by launching the actual tracking.
...
![alt text](./static/img/visualizeHeadEmbeddedTrackingResults.png)
